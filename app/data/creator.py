...
def mnist(out_filename, source_folder=None, dest_folder=getcwd(), depth=1,
    ...
    dataset_params = {
        'mnist_source_folder': source_folder or path.join("..", "source_data", "MNIST"),
...
def nbit_parity(out_filename, nbit=None, training_size = None, test_size = None, dest_folder=getcwd(), depth=1,
          one_hot=True, normalized=True, out_type="float", balanced_classes=False,
          n_batch=None, batch_size=None, validation_size=int(1000), save_stats=False):
    """Create a mnist dataset for DENN."""

    dataset_params = {
        'nbit': nbit or 3,
        'nsample_training' : training_size or 10000,
        'nsample_test' : test_size or 1000,
        'normalized': normalized,
        'onehot': one_hot
    }
